...
parser.add_argument('--arch', type=str, default='Train_search_diffevo', help='which architecture to use')
...
if torch.cuda.is_available():
    ...
    logging.info('GPU is not available, using CPU for computation')
