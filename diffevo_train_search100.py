...
DIR = "diffevo_search100-kde-{}".format(time.strftime("%Y%m%d-%H%M%S"))
...
# Instantiate DiffEvo
de_optimizer = DiffEvo(num_step=50, density='kde', noise=1.0, scaling=1, kde_bandwidth=0.1)
...
for epoch in range(args.epochs):
    ...
    torch.save(model.state_dict(), "diffevo-100-kde-model.pt")
    scheduler.step()
