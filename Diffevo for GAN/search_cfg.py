...
def parse_args():
    ...
    parser.add_argument('--num_op_g', type=int, default=1, help='The number of training operations over the network,/')
    ...
    parser.add_argument('--Total_evolutionary_algebra', type=int, default=20,
                        help='Algebra of Evolutionary Architecture')
    ...
    parser.add_argument('--warmup', type=int, default=10, help='epochs before EA')
    parser.add_argument('--num_individual', type=int, default=20, help='numbers of  EA individual')
    ...
    parser.add_argument('--start_search', type=int, default=200, help='Start searching arc')
    ...
    parser.add_argument('--mute_max_num', type=int, default=4, help='numbers of mute_max_num')
    parser.add_argument('--model_name', type=str, help='ues model of supernetG')
    parser.add_argument('--my_max_epoch_G', type=int, default=40, help='numbers of mute_max_num')
    parser.add_argument('--max_model_size', type=float, default=13, help='max model size')
