...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='arch_train_cifar10', help='experiment name')
    ...
    parser.add_argument('--max_epoch_G', type=int, default=121, help='max number of epoch for training G')
    ...
    parser.add_argument('--genotypes_exp', type=str, default='cifar10_D.npy', help='ues genotypes of the experiment')
    parser.add_argument('--cr', type=float, default=1)
    parser.add_argument('--ema_decay', type=float, default=0.999, help='ema')
    parser.add_argument('--genotype_of_G', type=str, default='arch_searchG_cifar10_2025_05_08_01_31_51/Model/best_fid_gen.npy', help='ues genotypes of the experiment')
